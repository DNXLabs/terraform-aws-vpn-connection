...
| vpn\_connection\_tunnel1\_phase1\_lifetime_seconds | The lifetime in seconds for phase 1 of the IKE negotiations for the first VPN tunnel. You can specify a number between 900 and 28800. | `number` | `28800` | no |
...
| vpn\_connection\_tunnel1\_phase2\_lifetime_seconds | The lifetime in seconds for phase 2 of the IKE negotiations for the first VPN tunnel. You can specify a number between 900 and 3600. The number that you specify must be less than the number of seconds for the phase 1 lifetime. | `number` | `3600` | no |
...
| vpn\_connection\_tunnel2\_phase1\_lifetime_seconds | The lifetime in seconds for phase 1 of the IKE negotiations for the second VPN tunnel. You can specify a number between 900 and 28800. | `number` | `28800` | no |
...
| vpn\_connection\_tunnel2\_phase2\_lifetime_seconds | The lifetime in seconds for phase 2 of the IKE negotiations for the second VPN tunnel. You can specify a number between 900 and 3600. The number that you specify must be less than the number of seconds for the phase 1 lifetime. | `number` | `3600` | no |
